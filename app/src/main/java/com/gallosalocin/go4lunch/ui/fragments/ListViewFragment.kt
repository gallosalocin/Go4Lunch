...
class ListViewFragment : Fragment(R.layout.fragment_list_view) {
    ...
    private lateinit var workmateListener: ListenerRegistration
            ...
            override fun onTextChanged(charSequence: CharSequence, i: Int, i1: Int, i2: Int) {
                ...
                placesClient.findAutocompletePredictions(request)
                        .addOnSuccessListener { response ->
                            getRestaurantDetails(response.autocompletePredictions[0].placeId)
                        }
    ...
    private fun getRestaurantDetails(placeId: String) {
        restaurantViewModel.detailsResultPS = PublishSubject.create()
    ...
    private fun getNearbyRestaurants() {
        ...
        restaurantViewModel.nearbyRestaurantListPS = PublishSubject.create()
